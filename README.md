...
* `mnist_cnn.pth`: The trained model weights (save/load functionality).
...
### 1. Clone the repo
```bash
git clone [https://github.com/YOUR_USERNAME/pytorch-mnist-journey.git](https://github.com/YOUR_USERNAME/pytorch-mnist-journey.git)
